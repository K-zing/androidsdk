...
public class GetNewComerActivityAPI extends CoreRequest {
    ...
    public GetNewComerActivityAPI addGetActivityListCallBack(GetActivityListCallBack getActivityListCallBack) {
